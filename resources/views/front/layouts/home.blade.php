...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">RAKHI</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          {{-- <li><a class="nav-link scrollto" href="#Country">Country</a></li>
          <li><a class="nav-link scrollto" href="#services">category</a></li>
          <li><a class="nav-link   scrollto" href="#portfolio">Portfolio</a></li>
          <li><a class="nav-link scrollto" href="#team">Team</a></li> --}}
          <li class="dropdown"><a href=""><span>News categories</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
               <li><a href="#trending">Trending news</a></li>
              <li><a href="#sports">Sports news</a></li>
              <li><a href="#political">Political news</a></li>
              <li><a href="#entertaiment">Entertainment news</a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto active" href="#portfolio">Gallery</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>WELCOME TO RAKHI NEWSPAPER </h1>
          <h2>We are  here to inform about current situation</h2>
  ...
  <main id="main">
    ...
    <!-- ======= About Us Section ======= -->
   {{--  <section id="Country" class="about">
      <div class="container" data-aos="fade-up">

        <div class="section-title">
          <h2>Country belongs</h2>
        </div>
        ...
        {{-- <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              ...
              <li>
                {{ $item->title }}
               <p class="p-4"> {{ $item->detail }}</p> --}}
                {{-- <div>
                   @foreach($post_data as $item)
                     <div class="card-body">
                      <img src="{{ asset('image/'.$item->image) }}" width="40%" height="50%" alt class="img-fluid">
                     </div>
...
<section id="sports" class="sports section-bg">
      <div class="container" data-aos="fade-up">
    ...
    <section id="political" class="political section-bg">
      <div class="container" data-aos="fade-up">
    ...
    <section id="entertaiment" class="political section-bg">
      <div class="container" data-aos="fade-up">
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Gallery of the news</h2>
          <p>Here is the  collection of photos which are belong to the news</p>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Rakhi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
